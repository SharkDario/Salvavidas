...
$campos = "última_fecha_ingreso, per_dni, per_nombre, per_apellido, per_sexo, per_fecha_nacimiento, per_tipo_sangre, pac_estatura, pac_peso, pac_qr, pac_id_paciente";
$lista_pacientes = $base_de_datos->select_all("vista_paciente_activos", $campos);