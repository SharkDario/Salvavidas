<?php
require "../../controllers/controlador_lista_epicrisis_1.php";
?>
<!DOCTYPE html>
...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Salvavidas | Lista Epicrisis</title>
	<style>
		.button_1 {
            background: #ff6a00;
            border: solid;
...
<body class="stretched" data-menu-breakpoint="1200" >
	...
	<div id="wrapper" class="bg-gradient-to-br from-orange-500 to-orange-700">
		...
		<section id="content" class="bg-gradient-to-br from-orange-300 to-orange-500 rounded-3xl shadow-lg p-8 max-w-9xl w-full mx-auto">
			<h1 class="aplicacion-salvavidas animate-pulse">Lista de Epicrisis</h1>	
							...
							<tbody>
								...
								<?php if (!empty($lista_pacientes)): ?>
									<?php foreach ($lista_pacientes as $paciente): ?>
										<tr>
											<td><?php echo htmlspecialchars($paciente['última_fecha_egreso']); ?></td>
									...
									<?php else: ?>
										<tr>
											<td colspan="11">No se encontraron pacientes inactivos.</td>
										</tr>
								<?php endif; ?>
